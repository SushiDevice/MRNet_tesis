...
class MRNet(nn.Module):
    def __init__(self):
        super().__init__()
        regnet = models.regnet_y_1_6gf(weights=models.RegNet_Y_1_6GF_Weights.IMAGENET1K_V1)
        self.regnet = nn.Sequential(regnet.stem, regnet.trunk_output)
        self.fc = nn.Linear(888, 1)
